...
namespace KdSoft.Lmdb
{
    ...
    public enum EnvironmentOptions
    {
        ...
        /// </summary>
        FixedMap = (int)DbLibConstants.MDB_FIXEDMAP,
        ...
        /// </summary>
        NoSubDir = (int)DbLibConstants.MDB_NOSUBDIR,
        ...
        /// </summary>
        NoSync = (int)DbLibConstants.MDB_NOSYNC,
        ...
        /// This flag may be changed at any time using mdb_env_set_flags().
        /// </summary>
        NoMetaSync = (int)DbLibConstants.MDB_NOMETASYNC,
        ...
        /// </summary>
        WriteMap = (int)DbLibConstants.MDB_WRITEMAP,
    ...
    public enum EnvironmentCopyOptions
    {
        ...
        /// </summary>
        Compact = (int)DbLibConstants.MDB_CP_COMPACT
    }
}